# Irish Gaelic (Gaeilge) Self-Study Progress Tracker

A small content-to-product funnel: a blog with Irish language learning guides, linking to a downloadable tracker template sold on Gumroad. See `decisions/niche-selection.md` for why this niche was chosen.
